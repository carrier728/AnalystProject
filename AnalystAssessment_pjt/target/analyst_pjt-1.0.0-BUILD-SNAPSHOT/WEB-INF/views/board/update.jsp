...
<body>
	<form action="updateOk" method="post" onsubmit="return formCheck();" id="myForm">
		...
		<table>
			<tr>
				<td colspan="4" class="title">자유 게시판 글수정</td>
			</tr>
			<tr>
				<th width="15%">아이디</th>
				<td width="35%">${id}</td>
			<tr>
				...
				<td width="35%" colspan="3">
					<input type="text" name="b_title" id="b_title" size="100" value="${vo.b_title }" required="required">
				</td>
			</tr>
			<tr>
				<th width="15%" valign="top">내용</th>
				<td width="35%" colspan="3">
					<textarea rows="15" cols="80" name="b_content" id="b_content" required="required">${vo.b_content }</textarea>					
				</td>
			</tr>
			<tr>
