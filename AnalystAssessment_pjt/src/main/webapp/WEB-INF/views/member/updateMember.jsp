...
<form action="updateMemberOk" method="post" onsubmit="return formCheck();">
    ...
    <div class="form-group">
		...
		<input class="form-control" id="disabledInput" type="text" value="${svo.m_userId }" disabled="disabled">
    </div>
    <input type="hidden" value="${m_userPw }" id="pw">
    <input type="hidden" value="${svo.m_userId }" name="m_userId">
    <div class="form-group">
    	<label for="exampleInputEmail1">이름</label>
      	<input type="text" class="form-control" id="m_userName" name="m_userName"
       	required="required" value="${svo.m_userName }">
    ...
    <div class="form-group">
      ...
      aria-describedby="emailHelp" value="${svo.m_email}" onkeyup="userEmailCheck()">
