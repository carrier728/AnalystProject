...
<body id="page-top">
    ...
    <header class="masthead">
      <div class="container">
      <c:if test="${empty sessionScope.svo }">
      ...
      <c:if test="${svo.m_lev==0 }">
        <div class="intro-text">
          <div class="intro-lead-in">Hello,</div>
          <div class="intro-heading text-uppercase">${svo.m_userName }님! 이메일 인증 후에 서비스 이용이 가능합니다.</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="${pageContext.request.contextPath }/verifyEmail">이메일 인증</a>
        </div>
      </c:if>
      <c:if test="${svo.m_lev==1 }">
        <div class="intro-text">
          <div class="intro-lead-in">Hello,</div>
          <div class="intro-heading text-uppercase">${svo.m_userName }님 환영합니다!</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="${pageContext.request.contextPath }/logOut">로그아웃</a>
        </div>
      </c:if>
      <c:if test="${svo.m_lev==9 }">
        <div class="intro-text">
          <div class="intro-lead-in">${svo.m_userName }님은 탈퇴한 회원입니다.</div>
          <div class="intro-lead-in">서비스 이용을 계속적으로 원하시면 아래의 번호로 연락시기 바랍니다.<br></div>
          <div class="intro-lead-in">고객 문의 전화 번호 : 02-000-0000<br></div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="${pageContext.request.contextPath }/logOut">로그아웃</a>
        </div>
      </c:if>
      <c:if test="${svo.m_lev==99 }">
        <div class="intro-text">
          <div class="intro-lead-in">Hello,</div>
          <div class="intro-heading text-uppercase">관리자 모드입니다!</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="${pageContext.request.contextPath }/logOut">로그아웃</a>
        </div>
      </c:if>
      </div>
...
<c:if test="${vo.m_lev==0 }">
	...
	<a href="${pageContext.request.contextPath }/memberOut">회원탈퇴</a><br>
