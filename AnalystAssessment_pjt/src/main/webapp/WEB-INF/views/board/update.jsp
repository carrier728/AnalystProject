...
<div class="container" style="margin-top: 10%; margin-bottom: 5%; width: 60%;">
	<form action="updateOk" method="post" onsubmit="return formCheck();" id="myForm">
		<input type="hidden" name="p" value="${map.p }">
		<input type="hidden" name="s" value="${map.s }">
		<input type="hidden" name="b" value="${map.b }">
		<input type="hidden" name="m" value="${map.m }">
		<input type="hidden" name="b_idx" value="${vo2.b_idx }">
		<input type="hidden" name="m_userId" value="${vo2.m_userId }">
		<input type="hidden" name="m_userPw" value="${vo2.m_userPw }">
		<table class="table table-hover">
			<tr>
				<td colspan="4" class="title" style="border:none; border-bottom: 1px solid gray;">자유게시판 글수정</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="35%" colspan="3">
					<input type="text" name="b_title" id="b_title" size="100" value="${vo2.b_title }" required="required">
				</td>
			</tr>
			<tr>
				<th width="15%" valign="top" class="table-primary" style="text-align: center; vertical-align: middle;">내용</th>
				<td width="35%" colspan="3">
					<textarea rows="15" cols="100" name="b_content" id="b_content" required="required">${vo2.b_content }</textarea>					
				</td>
			</tr>
			<tr>
